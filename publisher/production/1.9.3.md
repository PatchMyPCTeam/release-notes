---
title: "Publisher Version 1.9.3"
version: "1.9.3"
date: "2020-10-19"
type: "Production"
product: "Publisher"
author: "PatchMyPC Team"
keywords: "publisher, application update, in-place update, user-based installations, configmgr applications, intune updates, republished updates, intune scan wizard, scriptrunner, ccm client log, constrained language mode, icon resizing, uninstall content, powershell 2.0"
taxonomy:
    products:
